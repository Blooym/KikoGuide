...
sealed internal class PStrings
{
    ...
    /// <summary> The support button URL. </summary>
...
sealed internal class TStrings
{
    ...
    internal static string SettingsShowSupportButtonTooltip = Loc.Localize("UI.Screens.Settings.ShowSupportButton.Tooltip", "Show the support Kiko Guide button.");
